...
#define DIMMER_RELAY_NUM (18 - (DIMMER_LIGHT_HEAT_NUM_OPT + PT100_NUM + TIC_NUM))
...
#if (DIMMER_LIGHT_HEAT_NUM_OPT + (DIMMER_COVER_NUM * 2) + DIMMER_RADIATOR_NUM + PT100_NUM + TIC_NUM) > 18

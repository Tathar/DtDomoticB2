...
void DT_3voies_mcbt_raph_init()
{
    ...
    if (eeprom_config.mode_3voies_1_nath == DT_3voies_mcbt_raph_OFF || eeprom_config.mode_3voies_1_nath == DT_3voies_mcbt_raph_STANDBY)
    {
        // SetPoint_3voies_1 = 0;
        mode = DT3voies::mode::OFF;
    }
    else if (eeprom_config.mode_3voies_1_nath == DT_3voies_mcbt_raph_NORMAL)
    {
    ...
    else if (eeprom_config.mode_3voies_1_nath == DT_3voies_mcbt_raph_MANUAL)
    {
        // SetPoint_3voies_1 = scale(DT_pt100_get(DT_PT100_EXT), -10, 10, eeprom_config.SetPoint_auto_1_3voies_1_nath, eeprom_config.SetPoint_auto_2_3voies_1_nath);
    ...
    vannes.init(eeprom_config.pid_3voies_1_nath.KP, eeprom_config.pid_3voies_1_nath.KI, eeprom_config.pid_3voies_1_nath.KD, eeprom_config.pid_3voies_1_nath.KT, eeprom_config.pid_3voies_1_nath.action, eeprom_config.pid_3voies_1_nath.pmode, eeprom_config.pid_3voies_1_nath.dmode, eeprom_config.pid_3voies_1_nath.iawmode, DT_3voies_mcbt_raph_HOT, DT_3voies_mcbt_raph_HOT, DT_3voies_mcbt_raph_CIRCULATEUR, mode);
...
void DT_3voies_mcbt_raph_loop()
{
    ...
    if (eeprom_config.mode_3voies_1_nath == DT_3voies_mcbt_raph_NORMAL)
    {
    ...
    if (setpoint > DT_3voies_mcbt_raph_MAX)
        setpoint = DT_3voies_mcbt_raph_MAX;
    ...
    if (vannes.loop(DT_pt100_get(DT_3voies_mcbt_raph_CHAUFFAGE_PT100), setpoint) && now - old_now > 1000)
    {
        old_now = now;
...
void DT_3voies_mcbt_raph_set_mode(DT_3voies_mcbt_raph_mode mode)
{
    ...
    // sauvegardeEEPROM();
    if (eeprom_config.mode_3voies_1_nath == DT_3voies_mcbt_raph_OFF)
    {
        vannes.set_mode(DT3voies::mode::OFF);
    }
    else if (eeprom_config.mode_3voies_1_nath == DT_3voies_mcbt_raph_NORMAL)

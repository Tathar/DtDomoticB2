...
void DT_3voies_PCBT_raph_set_manual_setpoint(float setpoint); // set manual consigne temp
...
float DT_3voies_PCBT_raph_get_manual_setpoint(); // get manual consigne temp
float DT_3voies_PCBT_raph_get_setpoint(); // get consigne temp

...
#ifndef _DT_3voies_PCBT_raph
#define _DT_3voies_PCBT_raph
...
void DT_3voies_PCBT_raph_set_manual_setpoint(float setpoint); // set consigne temp MCBT
...
float DT_3voies_PCBT_raph_get_manual_setpoint(); // get manual consigne temp MCBT
float DT_3voies_PCBT_raph_get_setpoint(); // get consigne temp MCBT
float DT_3voies_PCBT_raph_get_temp_moyen();
